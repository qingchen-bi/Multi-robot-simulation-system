...
ScoutSkidSteer::ScoutSkidSteer(ros::NodeHandle *nh, std::string robot_name)
  ...
  // motor_fr_topic_ = "/scout_motor_fr_controller/command";
  // motor_fl_topic_ = "/scout_motor_fl_controller/command";
  // motor_rl_topic_ = "/scout_motor_rl_controller/command";
  // motor_rr_topic_ = "/scout_motor_rr_controller/command";
  // cmd_topic_ = "/cmd_vel";
}
